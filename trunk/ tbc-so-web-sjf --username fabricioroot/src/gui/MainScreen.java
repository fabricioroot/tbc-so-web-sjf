...
public class MainScreen extends javax.swing.JApplet {
    ...
    private void jButtonIntroductionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIntroductionActionPerformed
        final String TEXT_BASE_INTRODUCTION = "\n" +
                                              ...
                                              "*Este software educativo trata da política SJF (Shortest Job First - o menor processo primeiro).\n" +
                                              "A idéia desta política é passar o controle do processador para o processo que tenha o menor tempo de execução. Tal política possui algumas\n" +
                                              "características importantes: i) não-preempcão; ii) processos pequenos têm tempo de espera menor que os processos grandes;\n" +
                                              "iii) pode causar postergação (deixar em atraso) nos processos grandes; e iv) minimiza o tempo médio de espera de um conjunto de processos, pois os processsos\n" +
                                              "menores são executados mais rapidamente.\n\n" +
                                              "* VEJA O ALGORITMO ABAIXO";
        final String TEXT_BASE_ALGORITHM = "funcao sjf (referência de vetor<TAD_Processo> listaDeProntos, inteiro tamanho_maximo) : TAD_Processo\n" +
                                           "inicio\n" +
                                           "    TAD_Processo processo;\n" +
                                           "    inteiro aux := tamanho_maximo;\n\n" +
    ...
    private void jButtonStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonStartActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Para criar um processo, digite seu tempo de burst e clique em 'Criar'.\n" +
                ...
                "                                4) Passe o cursor do mouse sobre os processos prontos (Blocos Brancos) para ver seus tempos de burst e de criação.", "DICA", JOptionPane.INFORMATION_MESSAGE);
